...
- 박스 모델은 실제 내용이 들어가는 콘첸츠 영역, 테두리, 여백으로 구성
...
- block 요소 : 태그를 사용해서 요소를 삽입했을 때 혼자 **한 줄을** 차지하는 것, 해당 요소의 너비는 100%
- h1, div, p ...
